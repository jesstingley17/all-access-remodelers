  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        <section className="py-24 pb-20 bg-gradient-to-br from-[#111418] to-[#1C1C1C] text-white text-center" data-testid="section-terms-hero">
        ...
        <section className="py-24 bg-[#fafafa]" data-testid="section-terms-content">
          <div className="max-w-[900px] mx-auto px-5">
            <Card className="bg-white p-12 rounded-xl shadow-sm border border-[#111418]/8" data-testid="card-terms-content">
              <div className="prose prose-lg max-w-none text-[#4a4a4a]">
                <h3 className="text-[1.5rem] text-[#111418] font-semibold mb-4">Agreement to Terms</h3>
                ...
                <h3 className="text-[1.5rem] text-[#111418] font-semibold mb-4 mt-8">Services</h3>
                <p className="leading-[1.8] mb-6">
                ...
                <h3 className="text-[1.5rem] text-[#111418] font-semibold mb-4 mt-8">Estimates and Pricing</h3>
                ...
                <h3 className="text-[1.5rem] text-[#111418] font-semibold mb-4 mt-8">Payment Terms</h3>
                <ul className="list-disc pl-6 space-y-2 mb-6">
                ...
                <h3 className="text-[1.5rem] text-[#111418] font-semibold mb-4 mt-8">Warranties</h3>
                <p className="leading-[1.8] mb-6">
                ...
                <h3 className="text-[1.5rem] text-[#111418] font-semibold mb-4 mt-8">Liability</h3>
                <p className="leading-[1.8] mb-6">
                ...
                <h3 className="text-[1.5rem] text-[#111418] font-semibold mb-4 mt-8">Cancellation Policy</h3>
                <ul className="list-disc pl-6 space-y-2 mb-6">
                ...
                <h3 className="text-[1.5rem] text-[#111418] font-semibold mb-4 mt-8">Modifications</h3>
                <p className="leading-[1.8] mb-6">
